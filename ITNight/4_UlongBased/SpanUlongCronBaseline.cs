...
// span + ulong; same logic as SpanArrayCron

namespace ITNight
{
	public class SpanUlongCronBaseline: UlongCronExpressionBase
	{
		protected SpanUlongCronBaseline(ulong minute, ulong hour, ulong day, ulong month, ulong week)
			: base(minute, hour, day, month, week) { }

		public static SpanUlongCronBaseline Parse(string value)
		{
			...
			return new SpanUlongCronBaseline(minute, hour, day, month, week);
		}
