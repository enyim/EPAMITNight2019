...
namespace ITNight.Optimized
{
	...
	public abstract class UlongCronExpressionBase
	{
		...
		private readonly int firstMinuteRule;
		private readonly int firstHourRule;
		private readonly int firstDayRule;
		...
		protected UlongCronExpressionBase(ulong minute, ulong hour, ulong day, ulong month, ulong week)
		{
			...
			firstMinuteRule = minuteRule.TrailingZeroCount();
			firstHourRule = hourRule.TrailingZeroCount();
			firstDayRule = dayRule.TrailingZeroCount();
		}
