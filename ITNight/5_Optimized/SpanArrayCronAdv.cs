...
// span parsing + byte[] backend

namespace ITNight.Optimized
{
	public class SpanArrayCronAdv: ArrayCronExpressionBase
	{
		...
		public static SpanArrayCronAdv Parse(string value)
		{
			...
			return new SpanArrayCronAdv(minute, hour, day, month, week);
		}
