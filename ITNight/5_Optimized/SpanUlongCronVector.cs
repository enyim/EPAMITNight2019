...
// span + ulong, but AddRange uses Vector<ulong>

namespace ITNight.Optimized
{
	public class SpanUlongCronVector: UlongCronExpressionBase
	{
		protected SpanUlongCronVector(ulong minute, ulong hour, ulong day, ulong month, ulong week)
			: base(minute, hour, day, month, week) { }

		public static SpanUlongCronVector Parse(string value)
		{
			...
			return new SpanUlongCronVector(minute, hour, day, month, week);
		}
